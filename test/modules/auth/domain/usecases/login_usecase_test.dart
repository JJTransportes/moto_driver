...
void main() {
  ...
  group('call', () {
    test('returns Success on repository success', () async {
      when(() => mockRepository.signIn(any(), any(), any(), expectedRole: any(named: 'expectedRole')))
          .thenAnswer((_) async => Success(user));

      final result = await usecase.call('joao@moto.com', '123456', 'android', expectedRole: 'Driver');
      ...
      verify(() => mockRepository.signIn('joao@moto.com', '123456', 'android', expectedRole: 'Driver'))
          .called(1);
    });
